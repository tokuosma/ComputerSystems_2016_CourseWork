...
#define IEEE80154_MY_ADDR			0x0028 // PUT HERE YOUR DEVICE KIT NUMBER, FOR EXAMPLE: 29. -> 0x0029
#define IEEE80154_BROADCAST_ADDR	0xFFFF
#define IEEE80154_SINK_ADDR			0xBEEF // SEND YOUR TEST MESSAGES TO HERE 
